...
#SBATCH --job-name=RegressionModels(OSI&VentFREQ)   ## Name of the job for the scheduler
...
#SBATCH --time=2-23:59:59                    ## Maximum length of time you are reserving the resources for 
...
python -u RegressionModels_OSIandVentFREQ.py