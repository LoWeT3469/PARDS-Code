...
def run_bootstrap_ci(preds_json_path: str, split_name: str, out_dir: str):
    ...
    out_csv = os.path.join(out_dir, f"Regression_BootstrapCI_{split_name}_OSIandCNN_8.csv")
...
def run_learning_curves():
    ...
    lc_csv = os.path.join(out_revision_dir, "Regression_LearningCurve_OSIandCNN_8.csv")
...
def run_pca_sensitivity():
    ...
    pca_csv = os.path.join(out_revision_dir, "Regression_PCASensitivity_OSIandCNN_8.csv")
