...
#SBATCH --job-name=ClassificationModels(OSI&VentTIME)   ## Name of the job for the scheduler
#SBATCH --account=kayvan99                       ## name of the resource account (who is paying for the compute time)
#SBATCH --partition=spgpu                        ## name of the queue to submit the job to.   
                                                 ##(Choose from: standard, debug, largemem, gpu   ---  accordingly)
#SBATCH --time=8-23:59:59                        ## Maximum length of time you are reserving the resources for 
...
python -u ClassificationModels_OSIandVentTIME.py