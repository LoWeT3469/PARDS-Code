...
#SBATCH --job-name=RegressionModels(StatsCNN)   ## Name of the job for the scheduler
...
#SBATCH --time=3-23:59:59                       ## Maximum length of time you are reserving the resources for 
...
python -u RegressionModels_StatsCNN.py